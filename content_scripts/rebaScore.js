...
(function(exports) {
    ...
    const JOINT_CONNECTIONS = flipObject({
        headNeck: 15,
        neckChest: 16,
        chestNavel: 17,
        navelPelvis: 18,
    ...
    exports.augmentSkel = function augmentSkel(skel) {
        skel.joints[POSE_NET_JOINTS.HEAD] = average([
            skel.joints[POSE_NET_JOINTS.LEFT_EAR],
            skel.joints[POSE_NET_JOINTS.RIGHT_EAR],
        ]);
        skel.joints[POSE_NET_JOINTS.NECK] = average([
            skel.joints[POSE_NET_JOINTS.LEFT_SHOULDER],
            skel.joints[POSE_NET_JOINTS.RIGHT_SHOULDER],
        ]);
        skel.joints[POSE_NET_JOINTS.CHEST] = average([
            skel.joints[POSE_NET_JOINTS.LEFT_SHOULDER],
            skel.joints[POSE_NET_JOINTS.RIGHT_SHOULDER],
            skel.joints[POSE_NET_JOINTS.LEFT_SHOULDER],
            skel.joints[POSE_NET_JOINTS.RIGHT_SHOULDER],
        ...
        skel.joints[POSE_NET_JOINTS.PELVIS] = average([
            skel.joints[POSE_NET_JOINTS.LEFT_HIP],
            skel.joints[POSE_NET_JOINTS.RIGHT_HIP],
        ]);
    };
})(realityEditor.gui.ar.desktopRenderer.rebaScore);
